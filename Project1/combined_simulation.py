...
<mujoco model="Combined Zero Gravity Simulation">
  ...
  <default>
    <joint axis="0 0 1" range="-3.14159 3.14159" damping="0.5"/>
  ...
  <worldbody>
    ...
    <body name="target_marker" pos="0.5 0.0 0.4">
      <geom name="target_sphere" type="sphere" size="0.03" rgba="1 0 0 0.7" contype="0" conaffinity="0"/>
      <site name="target_site" pos="0 0 0" size="0.02" rgba="1 0 0 1"/>
    </body>
    
    <!-- 3D Frame marker for target position and orientation -->
    <body name="target_frame" pos="0.5 0.0 0.4">
      <!-- X-axis (red) -->
      ...
      <!-- Origin sphere -->
      <geom name="frame_origin" type="sphere" size="0.015" rgba="1 1 0 0.9" contype="0" conaffinity="0"/>
      <!-- Axis labels as small spheres -->
      <geom name="frame_x_tip" type="sphere" size="0.01" pos="0.2 0 0" rgba="1 0.5 0.5 1" contype="0" conaffinity="0"/>
      <geom name="frame_y_tip" type="sphere" size="0.01" pos="0 0.2 0" rgba="0.5 1 0.5 1" contype="0" conaffinity="0"/>
      <geom name="frame_z_tip" type="sphere" size="0.01" pos="0 0 0.2" rgba="0.5 0.5 1 1" contype="0" conaffinity="0"/>
    </body>
    ...
    <body name="robot_base" pos="0 0 0">
      <geom name="base_geom" type="mesh" mesh="link_0" material="kuka_grey" contype="1" conaffinity="1"/>
      
      <!-- Robot arm chain (same as original) -->
      <body name="link1" pos="0 0 0.1575">
        <joint name="joint1" axis="0 0 1" range="-2.96706 2.96706" damping="10.0"/>
        <inertial pos="0 0 0" mass="0.5" diaginertia="0.01 0.01 0.01"/>
        <geom name="link1_geom" type="mesh" mesh="link_1" material="kuka_grey"/>
        
        <body name="link2" pos="0 0 0.2025" quat="0 0 1 1">
          <joint name="joint2" axis="0 0 1" range="-2.0944 2.0944" damping="10.0"/>
          <inertial pos="0 0 0" mass="0.5" diaginertia="0.01 0.01 0.01"/>
          <geom name="link2_orange_geom" type="mesh" mesh="link_2_orange" material="kuka_orange"/>
          <geom name="link2_grey_geom" type="mesh" mesh="link_2_grey" material="kuka_grey"/>
          
          <body name="link3" pos="0 0.2045 0" quat="0 0 1 1">
            <joint name="joint3" axis="0 0 1" range="-2.96706 2.96706" damping="10.0"/>
            <inertial pos="0 0 0" mass="0.5" diaginertia="0.01 0.01 0.01"/>
            <geom name="link3_geom" type="mesh" mesh="link_3" material="kuka_grey"/>
            <geom name="band_geom" type="mesh" mesh="band" material="kuka_grey"/>
            <geom name="kuka_geom" type="mesh" mesh="kuka" rgba="0 0 0 1"/>
            
            <body name="link4" pos="0 0 0.2155" quat="1 1 0 0">
              <joint name="joint4" axis="0 0 1" range="-2.0944 2.0944" damping="10.0"/>
              <inertial pos="0 0 0" mass="0.5" diaginertia="0.01 0.01 0.01"/>
              <geom name="link4_orange_geom" type="mesh" mesh="link_4_orange" material="kuka_orange"/>
              <geom name="link4_grey_geom" type="mesh" mesh="link_4_grey" material="kuka_grey"/>
              
              <body name="link5" pos="0 0.1845 0" quat="0 0 1 1">
                <joint name="joint5" axis="0 0 1" range="-2.96706 2.96706" damping="10.0"/>
                <inertial pos="0 0 0" mass="0.5" diaginertia="0.01 0.01 0.01"/>
                <geom name="link5_geom" type="mesh" mesh="link_5" material="kuka_grey"/>
                <geom name="band5_geom" type="mesh" mesh="band" material="kuka_grey"/>
                <geom name="kuka5_geom" type="mesh" mesh="kuka" rgba="0 0 0 1"/>
                
                <body name="link6" pos="0 0 0.2155" quat="1 1 0 0">
                  <joint name="joint6" axis="0 0 1" range="-2.0944 2.0944" damping="10.0"/>
                  <inertial pos="0 0 0" mass="0.5" diaginertia="0.01 0.01 0.01"/>
                  <geom name="link6_orange_geom" type="mesh" mesh="link_6_orange" material="kuka_orange"/>
                  <geom name="link6_grey_geom" type="mesh" mesh="link_6_grey" material="kuka_grey"/>
                  
                  <body name="link7" pos="0 0.081 0" quat="0 0 1 1">
                    <joint name="joint7" axis="0 0 1" range="-3.05433 3.05433" damping="10.0"/>
                    <inertial pos="0 0 0" mass="0.5" diaginertia="0.01 0.01 0.01"/>
                    <geom name="link7_geom" type="mesh" mesh="link_7" material="kuka_grey"/>
    ...
    <body name="box_door_assembly" pos="1.3 0.5 0.5" quat="0.0 1.0 1.0 0">
      ...
      <body name="Base_Box" pos="0 0 0">
        <geom name="box_geom" type="mesh" mesh="Box" material="mat_box" contype="1" conaffinity="1" friction="0.7 0.1 0.1"/>
        ...
        <site name="door_handle_site" pos="0.15 -0.22 0.25" size="0.01" rgba="0 1 0 1"/>
      </body>
    </body>
  </worldbody>
  ...
  <keyframe>
    ...
    def position_controller(self):
        ...
        K_pos = np.diag([1.5, 1.5, 2.0]) *10         # Position velocity gains - higher Z gain for better vertical control
        K_orient = np.diag([0.8, 0.8, 0.8])*10       # Orientation velocity gain matrix
        K_angular_vel = np.diag([0.5, 0.5, 0.5]) *10    # Angular velocity damping gain matrix
        ...
        max_velocity = 5.0  # Maximum velocity limit (rad/s)
